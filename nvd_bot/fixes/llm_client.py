...
class LLMClient:
    ...
    def active_provider(self) -> str:
        ...
        if not config.OPENROUTER_API_KEY and config.GEMINI_API_KEY:
            return 'gemini'
